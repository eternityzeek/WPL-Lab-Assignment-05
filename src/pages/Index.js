                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-5">
                            <div className="intro-excerpt">
                                ...
                                <p className="mb-4">Explore Innovative Interior Designs at Our Modern Interior Design Studio.</p>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-12 col-lg-3 mb-5 mb-lg-0">
                            ...
                            <p className="mb-4">Our furniture is crafted with excellent materials to ensure durability, comfort, and style. Each piece is meticulously designed and constructed using high-quality materials, guaranteeing both functionality and aesthetic appeal. </p>
                ...
                <div className="container">
                    <div className="row justify-content-between">
                        <div className="col-lg-6">
                            ...
                            <p>With a wide range of stylish options, exceptional service, and affordable prices, we provide the perfect solution for all your furnishing needs.</p>
                            ...
                            <div className="row my-5">
                                <div className="col-6 col-md-6">
                                    <div className="feature">
                                        ...
                                        <p>Enjoy swift and complimentary delivery on all orders.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-6 col-md-6">
                                    <div className="feature">
                                        ...
                                        <h3>Easy to Shop</h3>
                                        <p>Browse our wide selection of products with ease and convenience.</p>
                                    </div>
                                </div>
                ...
                <div className="container">
                    <div className="row justify-content-between">
                        ...
                        <div className="col-lg-5 ps-lg-5">
                            ...
                            <p>Our team of interior design specialists is here to guide you through every step of creating your modern interior.</p>

                            <ul className="list-unstyled custom-list my-4">
                                <li>Explore our extensive collection of furniture and decor to find the perfect pieces for your modern living space.</li>
                                <li>Whether you're furnishing a room or an entire home, we offer personalized solutions to suit your style and budget.</li>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div className="product-item-sm d-flex">
                                ...
                                <div className="pt-3">
                                    <h3>Nordic Chair</h3>
                                    <p>Crafted with sleek lines and minimalist design, our Nordic chair offers both style and comfort, making it an ideal choice for modern interiors. </p>
                        ...
                        <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div className="product-item-sm d-flex">
                                ...
                                <div className="pt-3">
                                    ...
                                    <p>The Kruzo Aero chair combines contemporary elegance with ergonomic design, providing exceptional support and a sophisticated look to any workspace. </p>
                                    <p><a href="#">Read More</a></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div className="product-item-sm d-flex">
                                ...
                                <div className="pt-3">
                                    ...
                                    <p>Ergonomic chair features adjustable lumbar support, customizable armrests, and a breathable mesh back, ensuring optimal support throughout the day. </p>
                                    <p><a href="#">Read More</a></p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="col-lg-8 mx-auto">
                                                ...
                                                <div className="testimonial-block text-center">
                                                    <blockquote className="mb-5">
                                                        <p>&ldquo;"Exceptional quality and outstanding customer service! I couldn't be happier with my purchase from Modern Interior Design Studio. Highly recommended!" - Sarah T.&rdquo;</p>
                                                    </blockquote>
                                                    ...
                                                    <div className="author-info">
                                                        ...
                                                        <h3 className="font-weight-bold">Sarah.T</h3>
                ...
                <div className="container relative">
                    ...
                    <div className="row g-5 mb-5">
                        <div className="col-lg-4">
                            ...
                            <p className="mb-4">Contact us via our socials.</p>
